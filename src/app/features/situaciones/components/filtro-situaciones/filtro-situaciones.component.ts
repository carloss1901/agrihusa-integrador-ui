...
import { SituacionFilter } from '../../models/situacion.model';
...
@Component({
  selector: 'app-filtro-situaciones',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl:
    './filtro-situaciones.component.html'
})
export class FiltroSituacionesComponent {
  @Output()
  buscar = new EventEmitter<SituacionFilter>();
